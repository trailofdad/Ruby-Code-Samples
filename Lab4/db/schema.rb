...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "Album", :options => 'ENGINE=MyISAM', primary_key: "AlbumId", force: :cascade do |t|
  ...
  create_table "Artist", :options => 'ENGINE=MyISAM', primary_key: "ArtistId", force: :cascade do |t|
    t.string "Name", limit: 120
  end

  create_table "Customer", :options => 'ENGINE=MyISAM', primary_key: "CustomerId", force: :cascade do |t|
  ...
  create_table "Employee", :options => 'ENGINE=MyISAM', primary_key: "EmployeeId", force: :cascade do |t|
    t.string   "LastName",   limit: 20, null: false
  ...
  create_table "Genre", :options => 'ENGINE=MyISAM', primary_key: "GenreId", force: :cascade do |t|
    t.string "Name", limit: 120
  end

  create_table "Invoice", :options => 'ENGINE=MyISAM', primary_key: "InvoiceId", force: :cascade do |t|
  ...
  create_table "InvoiceLine", :options => 'ENGINE=MyISAM', primary_key: "InvoiceLineId", force: :cascade do |t|
  ...
  create_table "MediaType", :options => 'ENGINE=MyISAM', primary_key: "MediaTypeId", force: :cascade do |t|
    t.string "Name", limit: 120
  end

  create_table "Playlist", :options => 'ENGINE=MyISAM', primary_key: "PlaylistId", force: :cascade do |t|
    t.string "Name", limit: 120
  end

  create_table "PlaylistTrack", :options => 'ENGINE=MyISAM', id: false, force: :cascade do |t|
  ...
  create_table "Track", :options => 'ENGINE=MyISAM', primary_key: "TrackId", force: :cascade do |t|
